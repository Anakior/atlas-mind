...
GET_ROUTES = [
    ...
    router.Route(_RK.EXACT, "/api/admin/tokens", admin.tokens_get, _G.AUTH),
...
POST_ROUTES = [
    ...
    router.Route(_RK.EXACT, "/api/admin/tokens", admin.tokens_post, _G.CSRF_BASE),
...
DELETE_ROUTES = [
    ...
    router.Route(_RK.EXACT, "/api/admin/tokens", admin.tokens_delete, _G.CSRF_BASE),
