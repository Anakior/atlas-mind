...
document.addEventListener('keydown', (e) => {
  ...
  if (e.key === 'Escape' && !historyOverlay.classList.contains('hidden')) { closeHistory(); return; }
  if (e.key === 'Escape' && !tasksOverlay.classList.contains('hidden')) { closeTasks(); return; }
