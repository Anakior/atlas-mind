...
const STRINGS = {
  fr: {
    ...
    healthSharedAnchor: (s, n) => '« ' + s + ' » · ' + n + ' termes communs',
    healthConfHigh: 'valeurs',
    healthConfHighHint: 'Valeurs typées incompatibles sur le même sujet — signal fort.',
    healthConfLow: 'thème',
    healthConfLowHint: 'Termes rares partagés — piste à vérifier par l’IA.',
    healthNoCand: 'Aucun candidat 👌',
    healthAskAi: "Demande à l'IA de vérifier (elle lit ces docs via MCP).",
  ...
  en: {
    ...
    healthValueConflict: (s, a, b) => (s ? s + ': ' : '') + a + ' vs ' + b,
    healthSharedAnchor: (s, n) => '"' + s + '" · ' + n + ' shared terms',
    healthConfHigh: 'values',
    healthConfHighHint: 'Incompatible typed values on the same subject — strong signal.',
    healthConfLow: 'topic',
    healthConfLowHint: 'Shared rare terms — a lead for the AI to verify.',
    healthNoCand: 'No candidates 👌',
    healthAskAi: 'Ask the AI to check (it reads these docs via MCP).',
    healthReal: 'contradiction',
