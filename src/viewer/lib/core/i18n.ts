...
export const STRINGS: Record<'fr' | 'en', Record<string, I18nValue>> = {
  fr: {
    ...
    historyAiOnly: 'Écritures IA seulement',
    ...
    inboxQueue: 'À trier',
    inboxNoMatch: 'Aucun item ne correspond aux filtres.',
    inboxTypeTitle: (ty) => 'type : ' + ty,
  ...
  en: {
    ...
    inboxUpNext: 'Up next',
    inboxQueue: 'Queue',
    inboxNoMatch: 'No item matches the filters.',
    inboxTypeTitle: (ty) => 'type: ' + ty,
